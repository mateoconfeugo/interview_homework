...
staging_dir: /tmp
bogus_domain: bogus-app-homework
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :mkdirp yes :tangle  ansible/roles/lighttpd/templates/bogus-app-homework.conf.j2
...
- name: Copy module configuration for lighttpd
  template: src=lighttpd.conf.j2 dest=/etc/lighttpd/modules.conf
